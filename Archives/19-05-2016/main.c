...
//    Inspect_Default_Data_Packet(0b01);
    ...
    //CreatePiToIBCUARTMessage(CMD_PI_SN_ISCS, IBC_SN);
    //CreatePiToIBCUARTMessage(CMD_PI_DEFAULT_DATA, 0x0007);
//    CreatePiToIBCUARTMessage(CMD_PI_DEFAULT_DATA_B, 0x0007);
//        WaitTickCount(5000);
//    SendUARTPacket(); //Working
//    WaitTickCount(5000);
...
//    CreatePiToIBCUARTMessage(CMD_PI_ISC_PARENT, 0b00000001); //ISC SN
    ...
    //CreatePiToIBCUARTMessage(CMD_PI_DEFAULT_DATA_B, 0x3FFE); //ISC SN
    //SendUARTPacket(); //Working
    //WaitTickCount(5000);
...
// debug nic removed next two lines as they seem to be trouble shooting
...
void ReadEarthLeakage(void){   
    ...
    earthLeakageProblemUCG = (earthLeakageValueUS > VOLT_EL_HIGH)?1:0;//debug nic was ?1:0;
}
